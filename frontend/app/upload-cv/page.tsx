      ...
      <form onSubmit={onSubmit}>
              ...
              <div className="mx-auto text-center lg:w-2/3">
                ...
                <p className="mt-8 text-gray-700 dark:text-gray-300">
                  <ol className="list-none">
                    <li className="mb-7">
                      Click the "Choose File" button to upload the candidate's
                      CV in PDF format.
                    </li>
                    <li>Click the "Upload" button to update candidate's CV.</li>
                  </ol>
                </p>
                <div className="mt-16 flex flex-wrap justify-center gap-x-6 gap-y-4"></div>
              </div>
        ...
        <section className="w-300">
          <div className="justify-center flex flex-wrap justify-center gap-x-6 gap-y-4">
            <Label htmlFor="cv" className="mt-15">
              CV File
            </Label>
            <Input
              id="cv"
